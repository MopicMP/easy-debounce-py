...
> Easy debounce function calls (thread-safe)

[![PyPI version](https://badge.fury.io/py/easy-debounce-py.svg)](https://pypi.org/project/easy-debounce-py/)
...
```bash
pip install easy-debounce-py
```

## Quick Start

```python
from easy_debounce_py import py

# Basic usage
result = py("your input here")
print(result)
```
...
result = py("Hello World")

# Example 2: Batch processing
from easy_debounce_py import batch
